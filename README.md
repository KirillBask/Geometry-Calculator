...
Test task Junior/Middle C#

Question #1
Post the code on Github and include a link. If something is not clear in the task, describe the questions that arose and the assumptions made. For example, in the comments in the code.
Exercise:
...
If possible, put the answer next to the code from the first question.
